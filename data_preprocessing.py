...
bag = []  # Initialize bag as an empty list
...
def create_bot_corpus(words, classes, pattern_word_tags_list, ignore_words):
    ...
    for intent in data['intents']:
        ...
        # Add all tags to the classes list
            ...
            # add the 'tokenized word list' along with the 'tag' to pattern_pattern_word_tags_list
...
def preprocess_train_data(bag,pattern_word_tags_list):
...
bow_data  , label_data = preprocess_train_data(bag,pattern_word_tags_list)
